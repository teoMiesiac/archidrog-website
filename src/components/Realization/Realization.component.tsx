    ...
    <Flex flexDirection={['column', 'row', 'row']}>
      <ImageContainer flexDirection="column" width={['100%', '100%', '40%']} position="relative" top={[0, 0, '-50px']}>
        ...
        <Flex flexDirection={'row'} width={'100%'} justifyContent="space-between">
          <DesktopImage fluid={images[1].childImageSharp.fluid} width="50%" margin="20px 10px 0 0" />
          <DesktopImage fluid={images[2].childImageSharp.fluid} width="50%" margin="20px 0 0 10px" />
        </Flex>
      </ImageContainer>
      <Content padding={['10px 10px 30px']} flexDirection={'column'} width={['100%', '100%', '60%']}>
